<template>
  <div class="app-container">
    <el-form :model="form" ref="form" label-width="100px" v-loading="formLoading" :rules="rules">
      ...
      <el-form-item label="题卷类型：" prop="paperType" required>
        <el-select v-model="form.paperType" placeholder="题卷类型">
          <el-option
      ...
      <el-form-item label="题卷名称：" prop="name" required>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        paperType: [
          { required: true, message: "请选择题卷类型", trigger: "change" }
        ],
        name: [{ required: true, message: "请输入题卷名称", trigger: "blur" }],
        suggestTime: [
